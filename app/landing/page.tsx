...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Stats Section */}
      <LazySection className="py-16 border-y border-border/40" animationType="fade-up">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
      ...
      {/* Features Section */}
      <LazySection id="features" className="py-20" animationType="fade-left">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
      ...
      {/* Benefits Section */}
      <LazySection className="py-20 bg-muted/20" animationType="fade-right">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center mb-16">
            <h2 className="text-3xl font-bold tracking-tight text-foreground sm:text-4xl text-balance">
      ...
      {/* CTA Section */}
      <LazySection className="py-20" animationType="fade-up">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <div className="mt-8 flex items-center justify-center gap-x-6">
              ...
              <Button asChild variant="outline" size="lg" className="border-4 border-indigo-500/100">
      ...
      {/* Footer */}
      <LazySection className="border-t border-border/40 py-12" animationType="fade-up">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
