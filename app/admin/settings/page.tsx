        ...
        <TabsContent value="manufacturing" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Configure production and manufacturing parameters</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <Label htmlFor="defaultPriority">Default Work Order Priority</Label>
                  <Select
                    value={settings.manufacturing.defaultWorkOrderPriority}
                    onValueChange={(value) => updateSetting('manufacturing', 'defaultWorkOrderPriority', value)}
                  >
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                ...
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={(value) => updateSetting('manufacturing', 'stockConsumptionMethod', value)}
                  >
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => updateSetting('manufacturing', 'defaultLeadTime', parseInt(e.target.value))}
                  min="1"
                />
              </div>
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div>
                    <Label htmlFor="autoWorkOrders">Auto-create Work Orders</Label>
                    <p className="text-sm text-gray-500">Automatically create work orders when manufacturing orders are confirmed</p>
                  </div>
                  <Switch
                    id="autoWorkOrders"
                    checked={settings.manufacturing.autoCreateWorkOrders}
                    onCheckedChange={(checked) => updateSetting('manufacturing', 'autoCreateWorkOrders', checked)}
                  />
                </div>
                <div className="flex items-center justify-between">
                  <div>
                    <Label htmlFor="qualityControl">Quality Control Required</Label>
                    <p className="text-sm text-gray-500">Require quality control approval before completing work orders</p>
                  </div>
                  <Switch
                    id="qualityControl"
                    checked={settings.manufacturing.qualityControlRequired}
                    onCheckedChange={(checked) => updateSetting('manufacturing', 'qualityControlRequired', checked)}
                  />
                </div>
              </div>
            </CardContent>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Notify when product stock falls below minimum levels</p>
                  </div>
                  <Switch
                    id="lowStockAlerts"
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Notify when orders are past their deadline</p>
                  </div>
                  <Switch
                    id="overdueAlerts"
                    checked={settings.notifications.overdueOrderAlerts}
                    onCheckedChange={(checked) => updateSetting('notifications', 'overdueOrderAlerts', checked)}
                  />
                </div>
                <div className="flex items-center justify-between">
                  <div>
                    <Label htmlFor="maintenanceAlerts">System Maintenance Alerts</Label>
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => updateSetting('notifications', 'systemMaintenanceAlerts', checked)}
                  />
                </div>
              </div>
            </CardContent>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => updateSetting('security', 'allowMultipleSessions', checked)}
                  />
                </div>
                <div className="flex items-center justify-between">
                  <div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => updateSetting('system', 'dataRetentionDays', parseInt(e.target.value))}
                    min="30"
                  />
                </div>
              </div>
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Log performance metrics for optimization</p>
                  </div>
                  <Switch
                    id="performanceLogging"
                    checked={settings.system.performanceLogging}
                    onCheckedChange={(checked) => updateSetting('system', 'performanceLogging', checked)}
                  />
                </div>
              </div>
            </CardContent>
        ...
        <TabsContent value="maintenance" className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Perform system maintenance and backup operations</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="space-y-2">
                    <Button onClick={fetchSystemStats} className="w-full" variant="outline">
